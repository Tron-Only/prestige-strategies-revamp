...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className={cn("text-xs overflow-hidden", className)}
      {...props}
    >
      <div
        className={cn(
