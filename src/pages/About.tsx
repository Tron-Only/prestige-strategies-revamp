  ...
  return (
    <div className="container mx-auto py-8">
      <section className="text-center py-12">
        <h1 className="text-4xl font-bold">About Prestige Strategies</h1>
        <p className="text-lg text-muted-foreground mt-4 max-w-3xl mx-auto">
          ...
          support. We are committed to delivering excellence and driving growth
          for our clients.
        </p>
      </section>
      ...
      <section className="py-20 text-center">
        ...
        <p className="text-lg text-muted-foreground mt-4 max-w-3xl mx-auto">
          ...
          succeed. We bring a diverse range of skills and a shared commitment to
          our clients' success.
        </p>
